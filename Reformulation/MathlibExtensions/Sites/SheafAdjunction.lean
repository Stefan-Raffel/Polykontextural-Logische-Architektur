...
/-- The sheaf adjunction for the ClassifyingTopos T construction.
    ...
    target category (Mathlib instance `CategoryTheory.instHasSheafifyType`,
    anonymous in Mathlib, name generated by the elaborator and subject to change). -/
...
/-- Verification that HasSheafify holds for (geometricTopology T, Type (max u v)).
    ...
    Unconditional by the Mathlib instance `CategoryTheory.instHasSheafifyType`
    (anonymous in Mathlib, name generated by the elaborator and subject to change).
