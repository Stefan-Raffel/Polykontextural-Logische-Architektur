...
| Saetze gesamt | 1131 | geweitete grep-Satzroute ueber Reformulation/ allein (CLAUDE.md §3) |
| Saetze, verschaerfte Route | 1131 | Gegenprobe: nach dem Namen muss ( { [ ⦃ : oder Zeilenende folgen |
| def-Deklarationen | 460 | geweitete def-Route ueber Reformulation/ |
| Statement-Pins | 109 | grep '^-- STATEMENT-PIN' (Prosa-Kriterien sind eine Zeitbombe, §3) |
|  |  |  |
| **WACHEN** |  |  |
| Wachen geschrieben | 853 | grep '#guard_msgs.*in #print axioms' ueber Reformulation/ UND Foreign/ |
...
| Saetze im Aggregat | 950 | Satzroute, auf die Aggregathuelle eingeschraenkt |
| Wachen erzwungen | 843 | Wachenroute, auf die Huelle der Default-Targets eingeschraenkt |
...
| Gleichung *Wachen* | ✓ | 853 gegen 853 |
...
| geprueft (AxiomGate) | 4233 | Konstanten aus dem Importbaum, namensgefiltert auf Reformulation.* |
|  |  |  |
| **DOC-LINT** |  |  |
