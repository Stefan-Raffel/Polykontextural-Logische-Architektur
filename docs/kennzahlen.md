...
| Saetze gesamt | 1077 | geweitete grep-Satzroute ueber Reformulation/ allein (CLAUDE.md §3) |
| Saetze, verschaerfte Route | 1077 | Gegenprobe: nach dem Namen muss ( { [ ⦃ : oder Zeilenende folgen |
...
|  |  |  |
| **WACHEN** |  |  |
| Wachen geschrieben | 799 | grep '#guard_msgs.*in #print axioms' ueber Reformulation/ UND Foreign/ |
...
| Saetze im Aggregat | 896 | Satzroute, auf die Aggregathuelle eingeschraenkt |
| Wachen erzwungen | 789 | Wachenroute, auf die Huelle der Default-Targets eingeschraenkt |
...
| Gleichung *Wachen* | ✓ | 799 gegen 799 |
...
| geprueft (AxiomGate) | 4073 | Konstanten aus dem Importbaum, namensgefiltert auf Reformulation.* |
|  |  |  |
| **DOC-LINT** |  |  |
