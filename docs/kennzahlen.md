...
| Saetze gesamt | 1079 | geweitete grep-Satzroute ueber Reformulation/ allein (CLAUDE.md §3) |
| Saetze, verschaerfte Route | 1079 | Gegenprobe: nach dem Namen muss ( { [ ⦃ : oder Zeilenende folgen |
...
|  |  |  |
| **WACHEN** |  |  |
| Wachen geschrieben | 801 | grep '#guard_msgs.*in #print axioms' ueber Reformulation/ UND Foreign/ |
...
| Saetze im Aggregat | 898 | Satzroute, auf die Aggregathuelle eingeschraenkt |
| Wachen erzwungen | 791 | Wachenroute, auf die Huelle der Default-Targets eingeschraenkt |
...
| Gleichung *Wachen* | ✓ | 801 gegen 801 |
...
| geprueft (AxiomGate) | 4081 | Konstanten aus dem Importbaum, namensgefiltert auf Reformulation.* |
|  |  |  |
| **DOC-LINT** |  |  |
