...
| Saetze gesamt | 1104 | geweitete grep-Satzroute ueber Reformulation/ allein (CLAUDE.md §3) |
| Saetze, verschaerfte Route | 1104 | Gegenprobe: nach dem Namen muss ( { [ ⦃ : oder Zeilenende folgen |
...
|  |  |  |
| **WACHEN** |  |  |
| Wachen geschrieben | 826 | grep '#guard_msgs.*in #print axioms' ueber Reformulation/ UND Foreign/ |
...
| Saetze im Aggregat | 923 | Satzroute, auf die Aggregathuelle eingeschraenkt |
| Wachen erzwungen | 816 | Wachenroute, auf die Huelle der Default-Targets eingeschraenkt |
...
| Gleichung *Wachen* | ✓ | 826 gegen 826 |
...
| geprueft (AxiomGate) | 4176 | Konstanten aus dem Importbaum, namensgefiltert auf Reformulation.* |
|  |  |  |
| **DOC-LINT** |  |  |
