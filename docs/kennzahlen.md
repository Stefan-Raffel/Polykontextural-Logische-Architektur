...
| Saetze gesamt | 1112 | geweitete grep-Satzroute ueber Reformulation/ allein (CLAUDE.md §3) |
| Saetze, verschaerfte Route | 1112 | Gegenprobe: nach dem Namen muss ( { [ ⦃ : oder Zeilenende folgen |
...
|  |  |  |
| **WACHEN** |  |  |
| Wachen geschrieben | 834 | grep '#guard_msgs.*in #print axioms' ueber Reformulation/ UND Foreign/ |
...
| Saetze im Aggregat | 931 | Satzroute, auf die Aggregathuelle eingeschraenkt |
| Wachen erzwungen | 824 | Wachenroute, auf die Huelle der Default-Targets eingeschraenkt |
...
| Gleichung *Wachen* | ✓ | 834 gegen 834 |
...
| geprueft (AxiomGate) | 4186 | Konstanten aus dem Importbaum, namensgefiltert auf Reformulation.* |
|  |  |  |
| **DOC-LINT** |  |  |
